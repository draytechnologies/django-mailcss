...
from django_mailcss.tests.constants import TESTS_TEMPLATE_DIR
...
class MailCssTests(TestCase):
    def setUp(self):
        super(MailCssTests, self).setUp()
    ...
    def test_inline_css(self):
        ...
        content wrapped in the mailcss block.
        """
        template = get_template('mail_css.html')
        rendered = template.render({})
        self.assert_foo_and_bar_rendered(rendered)
